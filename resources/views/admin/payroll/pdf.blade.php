            ...
            <body>
                <div class="container">
                    ...
                    <table>
                        ...
                        <tr>
                            <th>Pag-IBIG Deductions</th>
                            <td>{{ number_format($payroll->pag_ibig_deductions, 2) }}</td>
                        </tr>
                        <tr>
                            <th>PhilHealth Deductions</th>
                        ...
                        <tr>
                            ...
                            <td>{{ number_format($payroll->sss_deductions + $payroll->pag_ibig_deductions + $payroll->philhealth_deductions + $payroll->tax, 2) }}</td>
                        </tr>
                        <tr>
                            <th>Net Salary</th>
