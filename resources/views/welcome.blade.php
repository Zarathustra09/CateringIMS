...
<main class="main">
    ...
    <!-- Hero Section -->
    <section id="hero" class="hero section" style="background-image: url('{{asset('landingpage/assets/img/hero-img.jpg')}}');">
        <div class="container">
            <div class="row gy-5 justify-content-center align-items-center">
                <div class="col-lg-8 col-xl-6 d-flex flex-column justify-content-center">
                    ...
                    <p data-aos="fade-up" data-aos-delay="100">Elevate your events with our seamless catering reservations, where every bite is a celebration of flavor and elegance!</p>
                    <div class="d-flex" data-aos="fade-up" data-aos-delay="200">
                        <a href="{{route('login')}}" class="btn-get-started">Reserve Now!</a>
